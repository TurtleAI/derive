defmodule Derive.Ecto.Operation.Transaction do
  @moduledoc """
...
defimpl Derive.Ecto.DbOp, for: Derive.Ecto.Operation.Transaction do
  def to_multi(%Derive.Ecto.Operation.Transaction{fun: fun}, index) when is_function(fun) do
